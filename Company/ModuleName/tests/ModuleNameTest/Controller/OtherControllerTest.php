...
namespace Company\ModuleNameTest\Controller\Admin;

use Company\ModuleName\Controller\Admin\MyController;
use Tests\Bootstrap;
...
class MyControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->service = $this->getMockBuilder('Company\ModuleName\Service\MyService')->disableOriginalConstructor()->getMock();
